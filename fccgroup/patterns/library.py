...
fingerprints: Dict[str, Union[str, Callable]] = {
    ...
    'Contains C': lambda x: count_pattern_occurrences(x, "[#6]"),
        ...
        'Ring system': lambda x: not apply_pattern(x, "[*&R0]"),
        'Contains ring': "[*&R]",
        ...
        'Contains styrene': lambda x: count_pattern_occurrences(Chem.AddHs(x), '[c&H1]1[c&H1][c&H1][c&H1][c&H1]c1-[C&H1]=[C&H2]'),
        'Contains styrene moiety': lambda x: count_pattern_occurrences(Chem.AddHs(x), '[c&H1]1[c&H1][c&H1][c&H1][c&H1]c1-[C&H1]~[C&H2]'),
    ...
    'Inorganic compound': lambda x, row: row["Organic C"] == 0,
    ...
    'Contains Hydrocarbons': lambda x, row: {'C','H'}.issubset(row["Molecular Composition"]),
        ...
        'Fully aromatic hydrocarbons': lambda x, row: row["Hydrocarbons"] and row["Aromatics"],
        ...
        'PAHs': lambda x, row: row["Hydrocarbons"] and row['PAH derivatives'] and row["Ring system"],
    ...
    'Contains Organo O': lambda x, row: {'C','O'}.issubset(row["Molecular Composition"]),
        ...
        'Contains ethylene glycol': lambda x: count_pattern_occurrences(x, '[#8]-C-C-[#8]'),
        'Contains butylene glycol': lambda x: count_pattern_occurrences(x, '[#8]-C-C-C-C-[#8]'),
        ...
        'Benzofurans': '[c&R1]1[c&R1][c&R1][c&R1][c&R2]2[c&R1,o&R1][c&R1,o&R1][c&R1,o&R1][c&R2]21',        
        'Benzofuran derivatives': '[#6&R1]1~[#6&R1]~[#6&R1]~[#6&R1]~[#6&R2]2~[#6&R1,#8&R1]~[#6&R1,#8&R1]~[#6&R1,#8&R1]~[#6&R2]~2~1',
        ...
        'Aliphatic carboxylic acids': lambda x, row: row["Organo O (strict)"] and row["Contains aromatic C"] == 0 and 
                                    row["Contains carboxylic acid"] != 0 and row["Contains O"] == 2,
        'Aliphatic carboxylic acid esters and salts': lambda x, row: row["Organo O (strict)"] and row["Contains aromatic C"] == 0 and 
                                    row["Contains carboxylic acid"] == 0 and row["Contains carboxylic acid derivatives"] != 0 and row["Contains O"] == 2,
        ...
        'Aliphatic carboxylic acids, esters and salts': lambda x, row: row["Organo O (strict)"] and not row["Contains aromatic C"] and row["Contains carboxylic acid derivatives"] == 1 and row["Contains O"] == 2,
    ...
    'Contains Organo N': lambda x, row: {'C','N'}.issubset(row["Molecular Composition"]),
        ...
        'Contains amine (loose)': lambda x: count_pattern_occurrences(Chem.AddHs(x), '[#7&X3]'),
        ...
        'Contains hydrazine': lambda x: count_pattern_occurrences(Chem.AddHs(x), '[#7&X3][#7&X3]'),
        'Contains imine': lambda x: count_pattern_occurrences(x, '[#1,#6]-[#7]=[#6](-[#1,#6])(-[#6,#1])'),
    ...
    'Contains Organo S': lambda x, row: {'C','S'}.issubset(row["Molecular Composition"]),
        ...
        'Contains thioaldehyde': lambda x: count_pattern_occurrences(x, '[#16&X1]=[#6]([#1])([#6,#1])'),
        ...
        'Contains thioamide': lambda x: count_pattern_occurrences(x, '[#16&X1]=[#6](-[#7])(-[#1,#6])'),
        ...
        'Benzothiophenes': '[c&R1]1[c&R1][c&R1][c&R1][c&R2]2[c&R1,s&R1][c&R1,s&R1][c&R1,s&R1][c&R2]21',
        'Benzothiophene derivatives': '[#6&R1]1~[#6&R1]~[#6&R1]~[#6&R1]~[#6&R2]2~[#6&R1,#16&R1]~[#6&R1,#16&R1]~[#6&R1,#16&R1]~[#6&R2]~2~1',
    ...
    'Contains Organo Cl': lambda x, row: {'C','Cl'}.issubset(row["Molecular Composition"]),
        ...
        'Contains vinyl chloride': lambda x: apply_pattern(x, '[C&H2]=[C&H1]-[#17]'),
        'Contains vinyl chloride moiety': lambda x: apply_pattern(x, '[C&H2]~[C&H1]-[#17]'),
        ...
        'Chlorinated alkanes': lambda x, row: row["Organo Cl (strict)"] and row["Contains aromatic C"] == 0 
                                    and row["Contains C#C"] == 0 and row["Contains C=C"] == 0,
        'Chlorobenzenes': lambda x: apply_pattern(Chem.AddHs(x), 'c1([Cl])c([#1,Cl])c([#1,Cl])c([#1,Cl])c([#1,Cl])c([#1,Cl])1'),
        ...
        'Chloroanilin derivatives': lambda x, row: row["Contains aromatic c~Cl"] > 0 and cx_smarts_query(Chem.AddHs(x), '[#6&H2]c1ccccc1.*Cl |m:7:2.3.4.5.6.7|'),
